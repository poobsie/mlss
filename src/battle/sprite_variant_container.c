#include "battle/bouncing_sprite_motion.h"
...
void* sub_8158044(struct BattleSpriteVariantContainer* object)
{
    ...
    if ((s32)((s32)(*(u8*)0x03001010 << 0x1B) >> 0x1B) <= 5) {
        object->secondVariant =
            battle_initialize_bouncing_sprite_variant_b(
                alloc_Zero(0x34, 1, (void*)0x082126E0, 0));
    } else {
        object->firstVariant =
            battle_initialize_bouncing_sprite_variant_a(
                alloc_Zero(0x34, 1, (void*)0x082126E0, 0));
    }
    return object;
}
...
{
    struct BattleBouncingSpriteMotion* first;
    struct BattleBouncingSpriteMotion* second;
