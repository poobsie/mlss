...
SEC(sub_8163A6C) void sub_8163A6C(void* p) {
    U16AT(p, 0x54) = U16AT(p, 0x52);
    U16AT(p, 0x58) = U16AT(p, 0x56);
}
...
SEC(sub_8171B44) void sub_8171B44(void* p) {
    if (*(vu16*)((u8*)0x0300034C + 0x2A) & 8)
        U32AT(p, 0x44) = 4;
}

SEC(sub_8199480) u8 sub_8199480(s16 x, s16 y) {
    return ((u16)sub_81DA690(x, y)) >> 8;
}
...
SEC(sub_81DCE7C) s32 sub_81DCE7C(void* value) {
    s32 i = 0;
    void** p = (void**)0x03001A78;
    while (i <= 0x13 && *p != value) {
        p += 2;
        i++;
    }
    return i;
...
SEC(sub_819A9B4) u8 sub_819A9B4(s32 value) {
    if (value <= 0x14)
        return 0xD7;
    if (value <= 0x50)
        return ((u8*)0x0821CA74)[value - 0x15];
    return 0;
}

SEC(sub_81DC49C) u32 sub_81DC49C(void) {
    ((void (*)(void)) * (void**)0x08CDB630)();
    return 8;
}

SEC(sub_81DC4B0) void sub_81DC4B0(void) {
    *(void**)0x08CDB630 = sub_81DC4C8;
    ((void (*)(void))sub_81DC4C8)();
}
