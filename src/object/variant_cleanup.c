...
#define DEFINE_VARIANT_CLEANUP(name, first, second)                       \
    extern s32 first(struct RuntimeObject*);                              \
    extern s32 second(struct RuntimeObject*);                             \
...
DEFINE_VARIANT_CLEANUP(
    sub_8093EA4, sub_8093F8C,
    object_initialize_snapshot_animation_with_random_duration)
