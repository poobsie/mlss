...
SEC(sub_806D548) s32 sub_806D548(struct RuntimeObject* object, void* owner) {
...
SEC(sub_806E624) void sub_806E624(struct RuntimeObject* object) {
    if (object->value80 == 0) {
        sound_effect_stop(0x99);
        sub_8082E1C(object, 4, 0, 0);
        sub_807F4FC(object);
        sound_effect_play(0x118, SOUND_VOLUME_UNCHANGED);
        object->update = sub_806E8E8;
    }
}
...
SEC(sub_8071018) s32 sub_8071018(struct RuntimeObject* object) {
    sound_effect_stop(0xA7);
    sub_8082E1C(object, 4, 0x40E7, 0);
    object->value80 = 0;
    object->update = sub_80711A4;
    sound_effect_play(0x55, SOUND_VOLUME_UNCHANGED);
    return 0;
}

SEC(sub_80745A8) void sub_80745A8(struct RuntimeObject* object) {
    struct RuntimeObject* first;
    struct RuntimeObject* second;
    struct RuntimeObject* third;

    first = object->linkedObject;
    second = first->linkedObject;
    third = second->linkedObject;
    sub_807C298(third->linkedObject);
    sub_807C298(third);
    sub_807C298(second);
    sub_807C298(first);
...
SEC(sub_8075DF4) void sub_8075DF4(struct RuntimeObject* object) {
    s32 temp_r0;
    s32 temp_r0_2;
    s32 temp_r1;
    struct RuntimeObjectVisual* visual;

    if (object->behaviorState == 2) {
        temp_r1 = object->valueA0 + 0xFFFFFA00;
        object->valueA0 = temp_r1;
        object->visual->value0C = (s16)temp_r1;
    }
    temp_r0 = object->valueA4;
    if (temp_r0 > 0) {
        temp_r0_2 = temp_r0 - 8;
        object->valueA4 = temp_r0_2;
        visual = object->visual;
        visual->value06 = (s16)temp_r0_2;
        visual->value04 = (s16)temp_r0_2;
    }
    if (object->value80 == 0) {
        sub_807C298(object);
    }
