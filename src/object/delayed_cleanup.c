...
DEFINE_DELAYED_CLEANUP_TRANSITION(object_finish_action_on_flags_38_or_after_24_ticks_variant, 0x17)
DEFINE_DELAYED_CLEANUP_TRANSITION(object_finish_action_on_flags_38_or_after_20_ticks_variant, 0x13)
